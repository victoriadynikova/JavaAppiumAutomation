...
public class MainPageObject {
    ...
    public String waitForElementPresentAndGetAttribute(String locator, String attribute, String error_message, long timeOutInSeconds) {
        WebElement element = waitForElementPresent(locator, error_message, timeOutInSeconds);
    ...
    public void tryClickElementWithFewAttempts(String locator, String error_message, int amount_of_attempts) {
        ...
        while (need_more_attempts) {
            try {
                ...
                if (current_uttempts > amount_of_attempts) {
                    this.waitForElementAndClick(locator, error_message, 5);
                }
            }
            current_uttempts++;
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message) {
        ...
        if (driver instanceof AppiumDriver) {
            ...
            int with = element.getSize().width;

            int point_to_click_x = (right_x + with) - 3;
